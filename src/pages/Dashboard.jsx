            ...
            <div className="dashboard-lower-grid">
                ...
                <Card className="border-divider/5 card-hover-glow">
                    ...
                    <div className="quick-actions-grid !grid-cols-1 sm:!grid-cols-2">
                        <Link to="/users" className="quick-action group">
                        ...
                        <Link to="/broadcast" className="quick-action group">
                        ...
                        <Link to="/devices" className="quick-action group">
                        ...
                        <Link to="/settings" className="quick-action group">
                ...
                <Card className="border-divider/5 card-hover-glow">
                    <div className="flex justify-between items-center mb-6">
                        ...
                        <Link to="/activity" className="text-[10px] text-blue-400 hover:underline uppercase tracking-widest font-bold">View Audit Trail</Link>
                    </div>
