                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="form-group text-left">
                                ...
                                <Select
                                    ...
                                    options={[
                                        { value: 'all', label: 'All Ecosystem Events' },
                                        { value: 'device_added', label: 'Device Registration' },
                                        { value: 'device_removed', label: 'Device Decommissioning' },
                                        { value: 'status_update', label: 'Status Perturbations' },
                                        { value: 'telemetry_update', label: 'Telemetry Pulse' },
                                    ]}
                                />
                            </div>
                        </div>
